...
news_parser = NewsParser(os.environ.get("OPENAI_API_KEY"), prompt = prompt, model = 'gpt-3.5-turbo-0125' )
...
file_path = "/home/adrian.alvarez/Projects/diariodeleon-scraper/results/gpt4o_row_results/analisis_noticias_gptmini.jsonl"
json_results = {}
